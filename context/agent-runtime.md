---
type: context
tags: [runtime, agents, boot]
updated: 2026-07-08
---

# Agent Runtime Adapter

Canonical adaptation layer for agents working inside a Camomile folder. Shared runtime map for Claude Code, Codex, and future agent shells.
...
- Graph navigation (`context/`, `state/`, `knowledge/`, `projects/`)
...
Codex / other shells:
- Treat root `AGENTS.md` as the workspace instruction layer, then use this adapter for folder-specific loading.
...
The agent here is an extension of the owner's memory and execution. Not a chatbot that forgets — an agent with opinions, memory, and evolution.
