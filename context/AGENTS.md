...
`context/` holds the stable rules, goals, and quality gates for this Personal OS. These files change rarely. Load them deliberately — most are not part of the every-session boot.
