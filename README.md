...
- **Видно, как идут дела в жизни целиком.** Семь сфер: саморазвитие (учёба и рост), витальность (тело и силы), окружение (люди рядом и где живёте), богатство (что для вас достаток), отдых (что восстанавливает), дело (чем занимаетесь), активы (деньги и имущество). Со временем видно, по каким сферам записей много, а по каким вы просто не говорили.
...
2. **Скачайте архив** — файл вида `camomile.zip`. Открытой страницы для скачивания пока нет: ссылку присылает тот, кто дал вам Ромашку. Двойной щелчок по архиву создаст рядом папку «Ромашка» — перенесите её в «Документы».
