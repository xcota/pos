...
- **No Python / it prints the "off for now" message** → that's fine. Say: *"Heads up — meaning-based
  search needs a free add-on I couldn't auto-install; everything else works great and I'll use
  regular search. You can add it later by typing `start` again."* Then continue. **Never block
  onboarding on this.**
...
> "That's it — you're set up. Restart me in this folder and say hi. Everything from here is yours and
> stays on your machine."

Optionally mention one power-up they can explore later, in one line: "When you're curious how the
brain works, ask me to explain `METHODOLOGY.md`."
