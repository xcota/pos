---
name: enable-modules
description: "Install/uninstall optional POS modules listed in modules.yaml. Use when: enable a module, install module, turn on a skill, /enable-modules, prune disabled modules."
version: 1.0
user_invocable: true
---
