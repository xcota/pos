...
2. Run `/vault-scaffolder {subject_id}` — generates the personalized Personal OS **in the current workspace** (skills + templates are already present from the starter)
